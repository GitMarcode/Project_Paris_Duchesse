...
class Instance:
    ...
    # availability: V[p] subset of offices
    V: Dict[Phase, Set[Office]]
...
def build_paris_duchesse_instance() -> Instance:
    ...
    S = ["P", "SA", "O", "T", "M"]  # Presidency, Students(?), Others, Teaching, Maintenance (as in your notation)
    P = [0, 1, 2, 3, 4, 5]
    T = [0, 1, 2, 3, 4]
    cap = 2
    ...
    # Initial allocation (phase 0) from your excerpt
    y0[("A1", "P")] = 2
    y0[("A2", "P")] = 2
    y0[("B1", "O")] = 1
    y0[("B1", "M")] = 1
    ...
    # Final allocation (phase 5) from your excerpt
    yF[("A1", "P")] = 2
    yF[("A2", "P")] = 2
    yF[("B1", "M")] = 1
    yF[("B2", "M")] = 2
